...
futurista** (Prompt 2), o **dashboard** (Prompt 3) e o **CRUD de automações**
(Prompt 4) — glassmorphism, azul neon, sidebar recolhível, grid responsivo,
modais e persistência no LocalStorage.
...
| `js/automations.js` | CRUD de automações: catálogos (categorias, tipos de ação, ícones e cores), repositório sobre o LocalStorage, renderização dos cards, modal de criar/editar com validação e modal de confirmação de exclusão. Semeia 3 automações na primeira visita. |
